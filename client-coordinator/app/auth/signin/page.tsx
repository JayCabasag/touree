    ...
    <>
      <section className="relative hidden md:flex md:w-1/2 h-screen overflow-hidden bg-primary-container">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAHAtuD3k9EaDMOdgAp6JuYr4k3xva4QHLAol9wvXmTIlTCs1mE1s8BHHcJmgvy9sSXxqmd_d469BeOiJ8_SwArUy1HJu1_dusHJ91mgELGkbJcApUPYJIvrL5rYVT3PciI6HOWABvduDzLxdStFoJVrSJGVjq8aDgbu6PtRtj5SIpzq6z58_FCbo9M0B881vzkhADtVfeDYO4w7xfnr0-EAXamt5v-qYNF62GmIdmvovhdaqitptvydx4OMSy9ysD9pOOxyuwkJZ8')",
          }}
        ></div>
      ...
      <section className="flex flex-col flex-1 items-center justify-center p-margin-mobile md:p-margin-desktop bg-surface min-h-screen">
        ...
        <div className="w-full max-w-md space-y-stack-md">
          ...
          <button className="w-full flex items-center justify-center space-x-3 py-3 border border-outline-variant bg-surface-container-lowest rounded-lg hover:bg-surface-container transition-colors focus:ring-2 focus:ring-outline outline-none">
