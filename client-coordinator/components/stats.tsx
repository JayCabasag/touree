    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
      ...
      <div className="glass-card p-4 rounded-2xl flex flex-col gap-3 transition-all hover:shadow-md border border-outline-variant">
        <div className="flex justify-between items-center">
          ...
          <span className="text-tertiary font-bold text-[10px]">8 New</span>
        </div>
        <div>
          <p className="text-on-surface-variant text-[10px] uppercase tracking-widest mb-0.5 opacity-70">
            Active Quotes
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="flex gap-0.5 items-end h-6">
              <div className="w-1 bg-secondary/20 rounded-full h-4"></div>
              <div className="w-1 bg-secondary/30 rounded-full h-5"></div>
              <div className="w-1 bg-secondary/40 rounded-full h-3"></div>
      ...
      <div className="glass-card p-4 rounded-2xl flex flex-col gap-3 transition-all hover:shadow-md border border-outline-variant">
        ...
        <div>
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="flex gap-0.5 items-end h-6">
              <div className="w-1 bg-tertiary/20 rounded-full h-3"></div>
              <div className="w-1 bg-tertiary/30 rounded-full h-2"></div>
              <div className="w-1 bg-tertiary/40 rounded-full h-5"></div>
              <div className="w-1 bg-tertiary rounded-full h-4"></div>
            </div>
          </div>
        </div>
      </div>
