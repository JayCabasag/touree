    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            className="w-full pl-12 pr-12 py-4 bg-surface-muted border border-outline-variant rounded-lg font-body-md text-body-md transition-all focus:bg-white"
            id="password"
            name="password"
            placeholder="••••••••"
            required
      ...
      <button
        className="w-full bg-primary text-on-primary py-4 rounded-lg font-headline-md text-headline-md flex justify-center items-center gap-2 hover:opacity-90 active:scale-[0.98] transition-all shadow-lg shadow-primary/20"
        type="submit"
      >
        Sign In
      </button>
